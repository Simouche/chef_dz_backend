...
class RequestDataFixer:
    """
    utility class for creating object to pass a modified version of request.data
    """
    ...
    def fix(self):
        obj = self.request.data.copy()
        obj['client'] = self.request.user.client.pk
        self.data = obj
